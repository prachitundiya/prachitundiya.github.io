...
if (visitForm) {
  visitForm.addEventListener("submit", (e) => {
    ...
    // Save to localStorage so dashboard can access
  ...
  localStorage.setItem("visitInfo", `Visit request submitted by <b>${name}</b> with email <b>${email}</b>.`);
    ...
    showPage("home");  // Go to home page after submission     
      
// Back button from Visit Form
const visitBackBtn = document.getElementById("visit-school-back");
visitBackBtn.addEventListener("click", () => {
  showPage("home");
});
